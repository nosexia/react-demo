...
const IconImput: FC<IconInputType> = ({ onChange, value = '', ParamsDefaultValue = '', ParamsName = '', ParamsType = '',...other }) => {

    function handleChange(e: any) {
        const value = e.target.value;
        onChange?.(parseTypeValue(ParamsType, value))
    }

    useEffect(() => {
        onChange?.(parseTypeValue(ParamsType, ParamsDefaultValue))
    }, [])
