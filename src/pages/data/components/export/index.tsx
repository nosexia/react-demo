...
import { message, Form, Select, Button, Modal } from 'antd';
...
const Export: FC<IProps> = ({ modalVisible, id, onOk, onCancel }) => {
                ...
                <ProFormSelect
                    fieldProps={{
                        ...
                        onChange: (value) => {
                            ...
                            //切换选择状态
                            console.log(genSheetFieldsMap[value])
